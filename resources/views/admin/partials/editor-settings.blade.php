@if($section === 'contacts')
  <div class="admin-card border-0 max-w-4xl mx-auto">
    <div class="admin-card-header py-3 d-flex align-items-center justify-content-between" style="background: var(--color-surface);">
      <h2 class="h5 mb-0 fw-bold" style="color: var(--color-text-main);"><i class="bi bi-telephone-outbound text-success me-2"></i>Informasi Kontak Global &amp; Lokasi</h2>
    ...
    <form action="{{ route('admin.home.update') }}" method="POST" class="admin-card-body p-4" style="background: var(--color-surface);">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-6">
          ...
          <div class="input-group">
            <span class="input-group-text text-info"><i class="bi bi-wrench-adjustable"></i></span>
        ...
        <div class="col-md-6">
          ...
          <div class="input-group">
            <span class="input-group-text text-danger"><i class="bi bi-file-earmark-pdf"></i></span>
      ...
      <div class="mt-4 border-top pt-4 text-end" style="border-color: var(--color-border) !important;">
...
@if($section === 'general')
  <div class="admin-card border-0">
    <div class="admin-card-header py-3 d-flex align-items-center justify-content-between" style="background: var(--color-surface);">
      <h5 class="mb-0 fw-bold" style="color: var(--color-text-main);"><i class="bi bi-gear-wide-connected text-warning me-2"></i>Pengaturan Umum, Identitas, Logo &amp; SEO</h5>
    ...
    <form action="{{ route('admin.home.update') }}" method="POST" enctype="multipart/form-data" class="admin-card-body p-4" style="background: var(--color-surface);">
      ...
      <div class="row g-4 mt-2">
        <div class="col-md-6">
          ...
          <div class="row g-3 align-items-center p-3 rounded-3 border" style="background: var(--color-surface-2); border-color: var(--color-border) !important;">
            <div class="col-sm-4 text-center">
              <div class="border rounded p-2 mx-auto d-flex align-items-center justify-content-center" style="width: 130px; height: 65px; background: var(--color-surface); border-color: var(--color-border) !important;">
        ...
        <div class="col-md-6">
          ...
          <div class="row g-3 align-items-center p-3 rounded-3 border" style="background: var(--color-surface-2); border-color: var(--color-border) !important;">
            <div class="col-sm-4 text-center">
              <div class="border rounded p-2 mx-auto d-flex align-items-center justify-content-center" style="width: 65px; height: 65px; background: var(--color-surface); border-color: var(--color-border) !important;">
        ...
        <div class="col-12">
          ...
          <div class="row g-3 align-items-center p-3 rounded-3 border" style="background: var(--color-surface-2); border-color: var(--color-border) !important;">
            <div class="col-sm-3 text-center">
              <div class="border rounded p-2 mx-auto d-flex align-items-center justify-content-center overflow-hidden" style="width: 160px; height: 90px; background: var(--color-surface); border-color: var(--color-border) !important;">
      ...
      <h6 class="mt-5 mb-3 fw-bold border-bottom pb-2" style="color: var(--color-text-main); border-color: var(--color-border) !important;"><i class="bi bi-search text-info me-2"></i>Pengaturan SEO &amp; Mesin Pencari</h6>
      <div class="row g-3">
        <div class="col-md-6">
      ...
      <!-- Media Sosial Links -->
      <h6 class="mt-5 mb-3 fw-bold border-bottom pb-2" style="color: var(--color-text-main); border-color: var(--color-border) !important;"><i class="bi bi-share text-accent me-2"></i>Link Akun Media Sosial Resmi</h6>
      <div class="row g-3">
        <div class="col-md-6">
          <div class="input-group">
            <span class="input-group-text text-danger" style="width: 45px; justify-content: center;"><i class="bi bi-instagram"></i></span>
        ...
        <div class="col-md-6">
          <div class="input-group">
            <span class="input-group-text text-primary" style="width: 45px; justify-content: center;"><i class="bi bi-facebook"></i></span>
        ...
        <div class="col-md-6">
          <div class="input-group">
            <span class="input-group-text text-info" style="width: 45px; justify-content: center;"><i class="bi bi-linkedin"></i></span>
        ...
        <div class="col-md-6">
          <div class="input-group">
            <span class="input-group-text text-dark" style="width: 45px; justify-content: center;"><i class="bi bi-twitter-x"></i></span>
