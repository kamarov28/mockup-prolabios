  ...
  <form action="{{ route('admin.home.update') }}" method="POST" enctype="multipart/form-data" class="admin-card-body p-4" style="background: var(--color-surface);">
    ...
    <div class="tab-content" id="homeTabsContent">
      ...
      <div class="tab-pane fade show active" id="hero-panel" role="tabpanel">
        <h2 class="h5 fw-bold mb-4 border-bottom pb-3" style="font-family: var(--font-headline); color: var(--color-text-main); border-color: var(--color-border) !important;">Hero Section Main Banner</h2>
          ...
          <div class="col-md-8">
            ...
            <div class="form-text mt-2 small text-secondary lh-base">
              ...
              <div class="mt-2 d-flex flex-column gap-1">
                <code class="bg-light text-dark border px-2 py-1 rounded user-select-all" style="font-size: 0.7rem; white-space: normal;">{{ '<span class="text-accent">Trusted</span>' }}</code>
                <span class="text-secondary" style="font-size: 0.65rem;">→ teks merah solid</span>
                <code class="bg-light text-dark border px-2 py-1 rounded user-select-all" style="font-size: 0.7rem; white-space: normal;">{{ '<span class="typo-outline">Trusted</span>' }}</code>
                <span class="text-secondary" style="font-size: 0.65rem;">→ outline transparan</span>
              </div>
              <div class="mt-2" style="font-size: 0.65rem;">Contoh isi field: <code>{{ '<span class="typo-outline">Trusted</span> Analytical & Microbiology Solutions' }}</code></div>
            </div>
          </div>
        </div>
        ...
        <h3 class="h6 fw-bold mb-3 border-bottom pb-2" style="color: var(--color-text-main); border-color: var(--color-border) !important;">Gambar Background Carousel Hero (Maks. 4 Gambar)</h3>
        <div class="row g-3">
          @for($i = 0; $i < 4; $i++)
            @php $imgUrl = $homeData['hero_images'][$i] ?? ''; @endphp
            <div class="col-md-6 col-lg-3">
              <div class="p-3 rounded-3 border h-100 d-flex flex-column justify-content-between" style="background: var(--color-surface-2); border-color: var(--color-border) !important;">
                <div>
                  ...
                  <div class="rounded border border-secondary border-opacity-20 overflow-hidden mb-3" style="aspect-ratio: 16/9; background: var(--color-surface-2);">
      ...
      <div class="tab-pane fade" id="bento-panel" role="tabpanel">
        <h2 class="h5 fw-bold mb-4 border-bottom pb-3" style="font-family: var(--font-headline); color: var(--color-text-main); border-color: var(--color-border) !important;">Bento Grid Standards & Infrastructure</h2>
        ...
        <h3 class="h6 fw-bold mb-3 border-bottom pb-2" style="color: var(--color-text-main); border-color: var(--color-border) !important;">4 Kartu Pilar Nilai (Bento Cards)</h3>
        <div class="row g-3">
          @for($i = 0; $i < 4; $i++)
            @php $bCard = $homeData['bento_cards'][$i] ?? []; @endphp
            <div class="col-md-6">
              <div class="p-3 rounded-3 border h-100" style="background: var(--color-surface-2); border-color: var(--color-border) !important;">
      ...
      <div class="tab-pane fade" id="sector-panel" role="tabpanel">
        <h2 class="h5 fw-bold mb-4 border-bottom pb-3" style="font-family: var(--font-headline); color: var(--color-text-main); border-color: var(--color-border) !important;">Interactive Sector Finder</h2>
      ...
      <div class="tab-pane fade" id="cta-panel" role="tabpanel">
        <h2 class="h5 fw-bold mb-4 border-bottom pb-3" style="font-family: var(--font-headline); color: var(--color-text-main); border-color: var(--color-border) !important;">Banner Konversi CTA Bawah (Bottom Banner)</h2>
