    ...
    <div class="max-w-2xl mx-auto p-4 p-md-5 rounded-4 border shadow-lg" style="background: var(--color-surface, #0e0e10); border-color: var(--color-border) !important; max-width: 680px;">
      ...
      <div class="p-3 mb-4 rounded-3 text-start" style="background: #070708; border: 1px solid var(--color-border);">
        <div class="row g-2 text-white small">
          ...
          <div class="col-sm-8 text-light">{{ $rfq->pic_name }} (<span style="color: var(--color-accent, #25D366);">{{ $rfq->email }}</span>)</div>
      ...
      <p class="text-secondary small mb-4" style="line-height: 1.6;">
        <i class="bi bi-envelope-check me-1" style="color: var(--color-accent, #25D366);"></i>
      ...
      <div class="d-flex flex-wrap justify-content-center gap-3">
        <a href="{{ route('rfq.track', ['number' => $rfq->rfq_number, 'token' => $rfq->access_token]) }}" class="btn btn-danger px-4 py-2 fw-semibold rounded-pill" style="background: #ff4950; border-color: #ff4950; box-shadow: 0 4px 14px rgba(255, 73, 80, 0.4);">
