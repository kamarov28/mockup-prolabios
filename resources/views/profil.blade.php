...
@section('meta_description', 'Profil PT Prolabios Mitra Analitika - Distributor terpercaya alat laboratorium dan instrumen di Indonesia. Mengenal visi, misi, dan sejarah perusahaan kami.')
@section('meta_keywords', 'profil perusahaan, prolabios, mitra analitika, visi misi, sejarah, distributor laboratorium, indonesia')
@section('canonical_url', url('/profil'))
