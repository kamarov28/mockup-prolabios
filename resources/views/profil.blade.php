      ...
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-4 order-last order-md-1">
          ...
          <div class="mb-5">
            ...
            <p style="font-size: 0.85rem; color: var(--color-text-muted); margin-bottom: 20px; line-height: 1.6;">Ikuti media sosial kami untuk mendapatkan informasi dan update terbaru.</p>
          ...
          <div class="profil-cta-box">
            ...
            <p style="font-size: 0.85rem; color: var(--color-text-muted); margin-bottom: 20px; line-height: 1.6;">Tim ahli kami siap membantu memilih instrumen dan reagen yang tepat.</p>
        ...
        <div class="col-lg-9 col-md-8 order-first order-md-2">
          ...
          <div class="mb-5">
            ...
            <h2 class="profil-section-title">Cerita Kami</h2>
            ...
            <div class="row g-4 mt-2">
              <div class="col-md-6">
                <div class="profil-vm-card">
                  ...
                  <h3 class="profil-vm-title">Visi Kami</h3>
              ...
              <div class="col-md-6">
                <div class="profil-vm-card">
                  ...
                  <h3 class="profil-vm-title">Misi Kami</h3>
          ...
          <!-- Core Values -->
          <div>
            <span class="profil-section-label">Nilai Inti Kami</span>
            <h2 class="profil-section-title">Nilai P-R-O</h2>
            <div class="row g-4 mt-2">
              <div class="col-md-4">
