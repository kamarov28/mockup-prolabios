...
<section class="section-spacious focus-section-pin">
  <div class="container">
    <div class="d-flex flex-wrap justify-content-between align-items-end mb-5 typo-section-head">
      <div>
        <h2 class="typo-section-title">{{ $homeData['sector_title'] ?? 'Interactive Sector Finder' }}</h2>
        <p class="typo-section-sub">{{ $homeData['sector_subtitle'] ?? 'Select your industry sector to explore tailored testing workflows and relevant products.' }}</p>
      </div>
    </div>
        ...
        <div class="row g-4 align-items-center">
          <div class="col-lg-6">
            ...
            <div class="d-flex gap-3 mt-4">
              <a href="{{ url($ph['link'] ?? '/sektor?s=pharmaceutical#sektor-nav') }}" class="typo-btn-link">Explore Pharma Solutions <i class="bi bi-arrow-right ms-1"></i></a>
            </div>
          </div>
          <div class="col-lg-6">
      ...
      <div class="hitech-tab-panel" id="panel-fnb">
        <div class="row g-4 align-items-center">
          <div class="col-lg-6">
            ...
            <div class="d-flex gap-3 mt-4">
              <a href="{{ url($fn['link'] ?? '/sektor?s=food#sektor-nav') }}" class="typo-btn-link">Explore F&amp;B Solutions <i class="bi bi-arrow-right ms-1"></i></a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="hitech-panel-box">
      ...
      <div class="hitech-tab-panel" id="panel-healthcare">
        <div class="row g-4 align-items-center">
          <div class="col-lg-6">
            ...
            <div class="d-flex gap-3 mt-4">
              <a href="{{ url($hc['link'] ?? '/sektor?s=hospital-clinic#sektor-nav') }}" class="typo-btn-link">Explore Healthcare Solutions <i class="bi bi-arrow-right ms-1"></i></a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="hitech-panel-box">
      ...
      <div class="hitech-tab-panel" id="panel-brewing">
        <div class="row g-4 align-items-center">
          <div class="col-lg-6">
            ...
            <div class="d-flex gap-3 mt-4">
              <a href="{{ url($br['link'] ?? '/sektor?s=brewing#sektor-nav') }}" class="typo-btn-link">Explore Brewing Solutions <i class="bi bi-arrow-right ms-1"></i></a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="hitech-panel-box">
