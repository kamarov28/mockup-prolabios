...
<head>
    <meta charset="utf-8">
    <title>Penawaran Disetujui</title>
    <style>
        ...
        .header h1 { margin: 0; font-size: 20px; color: #22c55e; text-transform: uppercase; letter-spacing: 1px; }
        .content { padding: 24px; }
        .badge { display: inline-block; padding: 4px 10px; background: #22c55e; color: #fff; font-size: 12px; font-weight: bold; border-radius: 4px; }
        ...
        .btn { display: inline-block; padding: 10px 20px; background: #22c55e; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 14px; margin-top: 16px; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            ...
            <p style="margin: 6px 0 0; font-size: 13px; opacity: 0.8;">Notifikasi Persetujuan Penawaran B2B (RFQ)</p>
        </div>
        <div class="content">
            ...
            <p style="font-size: 14px; margin-top: 16px;">Korporasi/instansi berikut telah menyetujui Surat Penawaran Harga Resmi. Mohon segera koordinasikan proses invoice dan pengiriman:</p>
            ...
            <table class="info-table">
                ...
                <tr><td class="label">Total Penawaran</td><td><strong>Rp {{ number_format((float) $rfq->total_offered_amount, 0, ',', '.') }}</strong></td></tr>
            </table>

            <h3 style="font-size: 15px; margin-bottom: 8px; color: #111;">Daftar Item yang Disetujui:</h3>
                ...
                <tbody>
                    @foreach($rfq->items as $item)
                        <tr>
                            ...
                            <td>Rp {{ number_format((float) $item->offered_price, 0, ',', '.') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div style="text-align: center; margin-top: 24px;">
                <a href="{{ route('admin.rfq') }}" class="btn" style="background-color: #22c55e !important; background: #22c55e !important; color: #ffffff !important; text-decoration: none !important; display: inline-block; padding: 12px 24px; border-radius: 6px; font-weight: bold; font-size: 14px; margin-top: 16px;"><span style="color: #ffffff !important; text-decoration: none !important;">Buka di Admin Dashboard</span></a>
            </div>
        </div>
        <div class="footer">
