...
| File | Scope |
|------|--------|
| tokens.css | Design tokens, color palette & typography variables |
| base.css | Reset, base typography & structural layout |
| motion.css | Universal tactile press physics & micro-interactions |
| components.css | Buttons, badges, cards, navigation & form controls |
