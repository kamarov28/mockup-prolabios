...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        try {
            ...
            Log::warning('Products indexing failed: '.$e->getMessage());
        }
        ...
        try {
            ...
            Log::warning('Posts indexing failed: '.$e->getMessage());
        }
        ...
        try {
            ...
            Log::warning('Sectors indexing failed: '.$e->getMessage());
        }
        ...
        try {
            ...
            Log::warning('RFQs indexing failed: '.$e->getMessage());
        }
        ...
        try {
            ...
            Log::warning('RFQ items indexing failed: '.$e->getMessage());
        }
        ...
        try {
            ...
            Log::warning('Users indexing failed: '.$e->getMessage());
        }
        ...
        try {
            ...
            Log::warning('Cache indexing failed: '.$e->getMessage());
        }
        ...
        try {
            ...
            Log::warning('Jobs indexing failed: '.$e->getMessage());
        }
    }
